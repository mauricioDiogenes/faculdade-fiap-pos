...
public class EstoqueView {
	...
	protected void createContents() {
		...
		ClienteDao clienteDao = (ClienteDao) FactoryBeanSpring.getBean("clienteDao");
		...
		EstoqueDao estoqueDao = (EstoqueDao) FactoryBeanSpring.getBean("estoqueDao");
		...
		btnAdicionarProdutor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					PedidoService pedidoService = (PedidoService) FactoryBeanSpring.getBean("pedidoService");
					
					List<PedidoView> lisPedidoViews = pedidoService.sumarizar(pedidoList, dataSistema);
