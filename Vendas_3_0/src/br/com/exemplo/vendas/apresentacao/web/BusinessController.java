...
public class BusinessController extends HttpServlet
{
	...
	private String process( HttpServletRequest _request,
	        HttpServletResponse _response, Action action )
	{
		try
		{
	...
	private void processForward( HttpServletRequest _request,
	        HttpServletResponse _response, String forward )
	{
		if ( forward == null )
		{
			return;
	...
	protected void processController( HttpServletRequest _request,
	        HttpServletResponse _response ) throws BusinessControllerException
	{
		try
		{
